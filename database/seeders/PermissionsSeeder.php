...
class PermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permission::create(['name' => 'list values']);
        Permission::create(['name' => 'view values']);
        Permission::create(['name' => 'create values']);
        Permission::create(['name' => 'update values']);
        Permission::create(['name' => 'delete values']);
