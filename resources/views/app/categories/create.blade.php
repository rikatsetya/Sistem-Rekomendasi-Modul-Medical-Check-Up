            ...
            <div class="row g-6">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1">@lang('crud.categories.create_title')</h4>
                        <p class="mb-0 text-muted">@lang('crud.categories.create_subtitle', [], 'Silakan isi data kategori')</p>
                    </div>
                ...
                {{-- Form --}}
                <x-form method="POST" action="{{ route('categories.store') }}" id="categoryForm">
