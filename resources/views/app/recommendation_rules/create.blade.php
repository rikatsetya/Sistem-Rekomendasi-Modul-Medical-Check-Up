    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-1">
                        <i class="ti tabler-file-plus me-2"></i>
                        Create Recommendation
                    </h4>
                    <small class="text-muted">
                        Tambahkan Recommendation Rule.
                    </small>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        <div class="border rounded p-4">
                            ...
                            <div class="row">
                                ...
                                <x-inputs.group class="col-md-6">
                                    <x-inputs.text name="max_score" label="Max Score" type="number" placeholder="100"
                                        required />
                                </x-inputs.group>
                            </div>
                        </div>
                        ...
                        <div class="border rounded p-4">
                            ...
                            <x-inputs.group>
                                <x-inputs.textarea name="recommendation_text" label="Recommendation Text" rows="3"
                                    required placeholder="Tuliskan saran rekomendasi..." />
                            </x-inputs.group>
