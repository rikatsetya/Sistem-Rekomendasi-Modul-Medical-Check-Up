    ...
    <div class="card mb-4">
        <div class="card-body py-3">
            <div class="toolbar">
                ...
                <form method="GET" action="{{ route('rekomendasi.index') }}" class="d-flex align-items-center gap-2">
                    <label class="fw-semibold small mb-0 text-nowrap">
                        <i class="ti tabler-calendar me-1"></i>Tahun MCU
                    </label>
                    <select name="tahun" id="yearSelect" class="form-select select2" style="min-width:110px;"
                        ...
                        @forelse($users as $i => $user)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span
                                        class="badge {{ $user->gender === 'l' ? 'bg-label-primary' : 'bg-label-danger' }}">
                                        {{ $user->gender === 'l' ? 'L' : 'P' }}
                                    </span>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted py-5">
                                    <i class="ti tabler-users ti-lg d-block mb-2"></i>
